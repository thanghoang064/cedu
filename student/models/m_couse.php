...
class M_couse extends database{
    ...
    {
        $sql = "SELECT kh.ma_khoa_hoc,kh.ten_khoa_hoc FROM lop as l,dang_ki as dk,khoa_hoc as kh WHERE dk.ma_lop = l.ma_lop and l.ma_khoa_hoc = kh.ma_khoa_hoc and dk.ma_nguoi_dung = ?";
        $this->setQuery($sql);
