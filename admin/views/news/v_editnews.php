                        ...
                        <form class="form-horizontal" id="form_addcouse" method="post" enctype="multipart/form-data" action="">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ten_tin_tuc" name="ten_tin_tuc" value="<?php echo $new->ten_tin_tuc;?>"  placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input  style=""  id="hinh_tin_tuc" name="f_hinh_tin_tuc" type="file" name="files[]" accept="image/*"  />
                                        <div class="col-xs-6  bg-white" id="image-holder4" style=" border-style: dashed; position: relative;width: 100%; padding-top: 56.25%;">
                                            <img src="../public/layout/imagesnews/<?php echo $new->hinh;?>"style=" position: absolute;top: 0;left: 0;bottom: 0;right: 0;height: 100%;width: 100%;" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="mo_ta_ngan" name="mo_ta_ngan" value="<?php echo $new->mo_ta_ngan;?>"  placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Nội dung</label>
                                    <div class="col-sm-9">
                                        <textarea name="noi_dung" class="form-control" required><?php echo $new->noi_dung;?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="trang_thai"  >
                                            <option  value="1" <?php if($new->trang_thai == 1) echo"selected"; ?>>Kích hoạt</option>
                                            <option value="0" <?php if($new->trang_thai == 0) echo"selected"; ?>>Bỏ kích hoạt</option>
                                        </select>
                                    </div>
                                </div>
