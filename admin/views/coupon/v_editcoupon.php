                        ...
                        <form class="form-horizontal" id="" method="post" action="">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ten_khuyen_mai" name="ten_khuyen_mai" value="<?php echo $coupon->ten_khuyen_mai;?>"  placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Phần trăm giảm giá</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="phan_tram_giam_gia" name="phan_tram_giam_gia" value="<?php echo $coupon->phan_tram_giam_gia;?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Ngày bắt đầu</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ngay_bat_dau" name="ngay_bat_dau" value="<?php echo date('Y-m-d', strtotime($coupon->ngay_bat_dau));?>"  placeholder="Ngày bắt đầu" readonly required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Ngày kết thúc</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ngay_ket_thuc" name="ngay_ket_thuc" value="<?php echo date('Y-m-d', strtotime($coupon->ngay_ket_thuc));?>"  placeholder="Ngày kết thúc" readonly required>
                                    </div>
                                </div>
                            </div>
