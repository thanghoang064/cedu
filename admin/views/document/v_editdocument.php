                ...
                <div class="col-md-6">
                    <div class="card">
                        <form class="form-horizontal" id="" enctype="multipart/form-data" method="post" action="">
                            <div class="card-body">
                                <h4 class="card-title">Sửa tài liệu</h4>
                                <div class="form-group row">
                                    <label for="cono1" class="col-sm-3 text-right control-label col-form-label" >Khóa học </label>
                                    <div class="col-md-9">
                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="ma_khoa_hoc" id="ma_khoa_hoc">
                                            ...
                                            foreach ($category as $ct)
                                            {
                                                ...
                                                <optgroup label="<?php echo $ct->ten_loai; ?>">
                                                    ...
                                                    foreach ($couse as $cs)
                                                    {
                                                        $selected = $documents->ma_khoa_hoc == $cs->ma_khoa_hoc ? "selected" : "";
                                                        ?>
                                                        <option <?php echo $selected ?>  value="<?php echo $cs->ma_khoa_hoc?>"><?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea  name="mo_ta_tai_lieu" class="form-control" required><?php echo  $documents->mo_ta_tai_lieu; ?> </textarea>
                                    </div>
                                </div>
