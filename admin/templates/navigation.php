    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="categorynews.php" aria-expanded="false"><i class="m-r-10 mdi mdi-apps"></i><span class="hide-menu">Danh mục tin tức-tin tức</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="rate.php" aria-expanded="false"><i class="m-r-10 mdi mdi-apps"></i><span class="hide-menu">Danh sách đánh giá</span></a></li>
